...
function header(name){
	...
	str += "		<a href=\"index.action\" title=\"广州粤嵌教育-购物商城\"><img alt=\"广州粤嵌教育-购物商城\" src=\"/shopping-mall/res/images/logo.gif\"></a>";
	str += "	</h1>";
	str += "</div>";
	...
	str += "	<em>";
	str += "	<img height=\"80\" width=\"552\" alt=\"广州粤嵌教育-购物商城\" border=\"0\" src=\"/shopping-mall/res/images/banner.gif\">";
	str += "	</em></a>";
	str += "</div>";
	str += "<div class=\"rlink\">";
	str += "	<ul>";
