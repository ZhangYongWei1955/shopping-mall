...
<script type="text/javascript">
	...
	var formOnblur = function(id) {
		...
		//提示图片
		var img = "<img alt='ok' src='${pageContext.request.contextPath}/res/images/pic_login_ok.gif'/>";
		//获取用户输入的值
		...
		if (id == "loginName") {
			...
			if (fieldValue == null || fieldValue == ""
				...
				$("userName_ok").innerHTML = "<img alt='ok' src='${pageContext.request.contextPath}/res/images/pic_login_ok.gif'>";
				flag = true;
			}
		} else if (id == "address") {
			if (fieldValue == null || fieldValue == ""
