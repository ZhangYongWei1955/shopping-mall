											...
											<tr style="display:none;" id="book_${stat.index}_${st.index}" >
												<td  align="center">
													<a href="item.action?id=${orderItem.article.id}" title="${orderItem.article.title}">
	                  								<img width="60px" height="60px" alt="${orderItem.article.title}" src="${pageContext.request.contextPath}/res/images/article/${orderItem.article.image}" style="display: inline;"></a>
	                  							</td>
												<td  align="center">
