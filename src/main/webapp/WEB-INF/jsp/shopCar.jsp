	        ...
	        <!-- 购物车不为空 <input  type="checkbox"  name="${shopCar.article.id}">-->
	        	<c:choose>
	        		...
	        		<c:otherwise>
	        			<table align="center">
			        		<tr>
			        			<td><img alt="" src="${pageContext.request.contextPath}/res/images/cart_icon.gif"/></td>
			        			<td>
		        ...
		        <div align="right" id="div_total" style="display: block;clear:both;">
		            ...
		            <p>
		                ...
		                <form action="${ctx}/order.action?step=1" method="post" id="form">
				            <td><a href="${ctx}/index.do" name="goon" class="goon"><img alt="" src="${pageContext.request.contextPath}/res/images/shop.jpg"/></a></td>
				            <!-- 通过隐藏输入框 将订单相关信息传递至后台 -->
				            <input type="hidden" name="orderInfo" id="orderInfo"/>
				            <td>
								<button id="commitOrder" style="background-image: url(${pageContext.request.contextPath}/res/images/balance.jpg);width: 140px;height: 35px" 
